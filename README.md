...
---
## Висновок
У процесі роботи над WeatherApp я:

- поглибив знання Python + PyQt6 — особливо робота з інтерфейсом, налаштування та теми;

- відчув різницю між роботою з JSON та базою даних для зберігання даних — і тепер можу свідомо вибирати потрібний варіант;

- навчився адаптовувати UI з локалізацією та багатомовністю;

- навчився краще структурувати документацію: використання README, якірних посилань, скріншотів, форматування.

Що можна зробити далі:

- оптимізувати пошук міст та розв'язати проблему однакових назв;

- більш детально проробити варіант додавання міст через координати;

- спробувати винести проєкт у мобільний формат.
